...
export default function MobileTelephonyPage() {
  ...
  const [integrationsList, setIntegrationsList] = useState<Integration[]>(() =>
    INITIAL_MOCK_INTEGRATIONS.filter((i) => i.category === "Mobile Telephony")
  );
    ...
    <RouteGuard module="integrations">
      <div className="space-y-6 pb-12">
        ...
        <div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-1 border-b border-border/60">
            <div className="flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-purple-500/10 text-purple-600 dark:text-purple-400 border border-purple-500/20 shadow-2xs">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Configure Plivo-based calling, recording, and number provisioning.
                </p>
              </div>
            </div>
          </div>
        ...
        <IntegrationToolbar
          ...
          currentRoute="telephony"
          createButtonText="Create Telephony Agent"
